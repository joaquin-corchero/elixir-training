defmodule GithubApi.GithubControllerTest do
  ...
  test "Get /users/:user responds with 200 Different approach" do
  ...
  test "Get /users/:user returns the user in json" do
    conn = conn(:get, "users/elixir-lang")
  ...
  test "Get /users/:user/repos responds with 200" do
  ...
  #test "Get /users/:user/repos returns the user in json" do
  #  conn = conn(:get, "users/elixir-lang/repos")
  #  {:ok, expected} = %User{login: "elixir-lang", public_repos: 15} |> Poison.encode
  #  response = GithubApi.Router.call(conn, [])
  ...
  test "Get /users/:user/repos/languages responds with 200" do
    conn = conn(:get, "users/elixir-lang/repos/languages")
    response = GithubApi.Router.call(conn, [])
